...
$customerRequestNo = "FE" . date("ymd_His") . rand(10, 99);
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<body>
		<table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #107929">
		  ...
		  <tr>
		  	<td colspan="2" bgcolor="#CEE7BD">聚合API请求</td>
		  </tr>

			<form method="post" action="sendFePay.php" targe="_blank">
 	...
 	<tr>
		...
		<tr>
      	...
      	<tr>
		  	<td align="left">&nbsp;&nbsp;产品</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="product" id="product"  value=""/>
      	&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
		  	<tr>
		  	<td align="left">&nbsp;&nbsp;产品服务</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="productService" id="productService"  value=""/>
      	&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
      ...
      &nbsp;</td></tr>
		 ...
		 <tr>
	  	  ...
	  	  <tr>
		<td align="left">&nbsp;&nbsp;用户扫码api</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="payWay" id="payWay"  value=""/>
      &nbsp;</td></tr>
		...
		<tr>
      	...
      	&nbsp; </td></tr>
			<tr>
		  	<td align="left">&nbsp;&nbsp;币种</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="currency" id="currency"  value="CNY"/>
      	&nbsp; </td></tr>
	   ...
	   <tr>
	  	...
	  	<tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="bankCode" id="bankCode"  value="OFFLINE"/>
      	&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
