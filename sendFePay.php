...
function fepay(){
    ...
    $request->addParam("product", $_REQUEST['product']);
    $request->addParam("productService", $_REQUEST['productService']);
	$request->addParam("payWay", $_REQUEST['payWay']);
 ...
 $request->addParam("assurePeriod", $_REQUEST['assurePeriod']);
   ...
   $request->addParam("memo", $_REQUEST['memo']);
    ...
    $response = YopClient3::post("/rest/v1.0/bc/fe-order/create", $request);
	print_r($response);
...
<title>	聚合API--响应参数
	...
	<body>	
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
			...
			<tr >
				<td width="25%" align="left">&nbsp;返回数据</td>
				<td width="5%"  align="center"> : </td> 
				<td width="65"  align="left"> <textarea id="resultData" style="width: 100%;" name="resultData" rows="15"  ><?php print_r( $result['resultData']);?> </textarea></td>
